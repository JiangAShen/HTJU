...
cmd = ' python main.py --batch_size 20 --data data/penn --dropouti 0.45 --dropouth 0.3 --seed 141 --epoch 200 --save PTB.pt --when 100 145 --clip 0.25 --beta1 0.9 --beta2 0.999 --optimizer htju --lr 0.001 --eps 1e-8 --wdecay 1.2e-6 --nlayer 1 --run 0'
os.system(cmd)

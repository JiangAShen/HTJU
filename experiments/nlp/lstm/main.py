...
from optimizers import Yogi, MSVAG, RAdam, AdamW, Fromage

# Optional external optimizer imports
try:
...
# HTJU family — add parent dir to path
import sys
...
try:
    ...
    if args.optimizer == 'amsbound':
        ...
        optimizer = MSVAG(params, args.lr, betas=(args.beta1, args.beta2),
                          weight_decay=args.wdecay)
    elif args.optimizer == 'htju':
        optimizer = HTJU(params, t_lr=args.lr, h_lr=args.lr,
                          t_weight_decay=args.wdecay, H_optim='AdamW',
                          weight_decay_type='AdamW', total_epoch=args.epochs,
